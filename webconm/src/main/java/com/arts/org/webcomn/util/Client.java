...
public class Client {
	...
	private String serviceURLI = "http://sdk2.entinfo.cn:8060/gjWebService.asmx";
	...
	public String mdSmsSend_g(String mobile, String content, String ext, String stime,
		...
		try {
			...
			String inputLine;
			while (null != (inputLine = in.readLine())) {
				Pattern pattern = Pattern.compile("<mdSmsSend_gResult>(.*)</mdSmsSend_gResult>");
				Matcher matcher = pattern.matcher(inputLine);
				while (matcher.find()) {
					result = matcher.group(1);
				}
